...
using MarketApi.Models.Repositories;
...
namespace MarketApi
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            {
                serviceScope.ServiceProvider.GetService<MarketContext>().Database.Migrate();
                serviceScope.ServiceProvider.GetService<MarketContext>().EnsureSeedData();
            }
        }
    }
}
